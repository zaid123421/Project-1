...
// useEffect
  useEffect(() => {
    fetch(`http://localhost:3000/web/users/${id}`)
    .then((res) => res.json())
    .then((res) => {
      console.log(res);
    ...
    <>
      <div>
        <div>
          ...
          <h1 className = "special-head ml-15">User Details</h1>
        </div>
        <div className = "user-details-box">
          <div className = "user-details w-50">
            ...
            {/* <div className = "d-flex align-c justify-sb mb-30">
              <h2 className = "fs-18">Phone Number:</h2>
              <p className = "fs-14">+963 936 293 119</p>
            </div> */}
          ...
          {/* <i className = "fa-solid fa-wallet table-icon"></i> */}
