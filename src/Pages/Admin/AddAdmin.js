...
export default function AddAdmin() {
  ...
  async function Submit(e) {
    ...
    try {
      if(flag) {
        let res = await axios.post('http://localhost:3000/web/add_admin', {
          username: username,
          email: email,
          password: password,
          role: role
  ...
  return (
    <>
      <div className = "add-admin-page d-flex align-c justify-c">
        <NavLink to = "/home/admins">
        ...
        <div className = "add-admin-card">
          ...
          <div>
            ...
            <i className="fa-solid fa-chevron-down arrow-down cursor-p"></i>
          </div>
